...
class QuizRepositoryMockImpl @Inject constructor(
    ...
    override suspend fun getAllQuizzes(): RepoResult<List<Quiz>> = RepoResult.Success(
        listOf(
            Quiz(
                "agahah", "Chem", 1620990300, 20, listOf(
                    Question(
                        "jhdjhdj",
                        "What is Android?",
                        listOf("OS", "A type of cake", "Phone", "None of the Above"),
                        0
                    )
                )
            )
